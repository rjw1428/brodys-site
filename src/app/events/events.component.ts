...
export class EventsComponent implements OnInit {
  ...
  sideTitle = "EVENTS"
  eventTitle: string[] = ["LUPE'S SPECIAL", "HAPPY HOUR", "ON THE ROAD"]
  ...
  img: string[] = [
    ...
    'https://firebasestorage.googleapis.com/v0/b/brodys-192703.appspot.com/o/site-images%2Ftruck.jpg?alt=media&token=5cd1f40a-5bc5-478e-95cd-d04f41b1c043']
  
  description: string[]=[
    'This is the special of the week',
    'Happy hour 4-6 pm every day, note some of our beers are not available during happy hour',
    'Come meet us on the road at our next event'
  ]
  constructor() { }
